  ...
  tutorialSidebar: [
    ...
    },
    {
      ...
      items: [
        {
          type: 'category',
          label: 'MCP Services and Ecology',
          link: {
            type: 'generated-index',
          },
          collapsed: true,
          items: [
            {
              type: 'doc',
              id: 'integration/tidas-to-ai',
            },
            {
              type: 'link',
              label: '天工 LCA MCP',
              description: '天工 LCA MCP 文档',
              href: 'https://docs.tiangong.earth/category/集成与扩展',
            },
          ],
        },
        {
          type: 'doc',
          id: 'integration/tidas-blockchain',
        },
        {
          type: 'doc',
          id: 'integration/tidas-permission-control',
        },
        {
          type: 'doc',
          id: 'integration/tidas-privacy-computing',
        },
      ],  
    },
    {
